        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <img src={logotype.src} alt="UN Wheels" className="h-12" />
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link href="/login" className="text-gray-200 hover:text-white text-sm font-medium px-4 py-2 transition-colors">
                Iniciar sesión
              </Link>
              <Link href="/register" className="bg-primary hover:bg-primary-dark text-white text-sm font-semibold px-5 py-2 rounded-xl shadow-md transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
                Registrarse
              </Link>
            </div>
          ...
          <div className="md:hidden border-t border-white/10 animate-fade-in" style={{ background: 'rgba(10,10,36,0.97)' }}>
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="pt-3 border-t border-white/10 flex flex-col gap-2">
                <Link href="/login"    className="text-center py-2.5 text-white border border-white/20 rounded-xl text-sm">Iniciar sesión</Link>
                <Link href="/register" className="text-center py-2.5 bg-primary text-white rounded-xl font-semibold text-sm">Registrarse</Link>
              </div>
            </div>
          </div>
        )}
