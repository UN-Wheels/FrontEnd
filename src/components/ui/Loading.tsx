...
export function Loading({ size = 'md', className = '', fullScreen = false, message }: LoadingProps) {
  ...
  if (fullScreen) {
    return (
      <div className="fixed inset-0 min-h-screen bg-gradient-to-br from-secondary-dark via-secondary-medium to-secondary flex items-center justify-center p-4 z-50">
        {spinner}
      </div>
    );
  }
